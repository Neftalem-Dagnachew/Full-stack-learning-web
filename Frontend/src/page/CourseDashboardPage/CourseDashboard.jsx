                ...
                { courses.length > 0 ? (courses.map((course) => (
                    ...
                    <div className="course_cards">
                        ...
                        <div className="h-50 gap-3 d-flex justify-content-center flex-column">
                            ...
                            <Link to={`/my-dashboard/course/${course.id}/${course.grade_level}/${course.subject_name}`}className="see_course_btn d-flex align-items-center justify-content-center ms-3">See</Link>
